                        ...
                        <div class="mt-4">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <div class="text-lg font-semibold"><?php echo e(number_format($totalRevenue, 2)); ?> PKR</div>
                                </div>
                                <div>
                                    <div class="text-gray-500">Total Payments</div>
                                    <div class="text-lg font-semibold"><?php echo e(number_format($totalPayments, 2)); ?> PKR</div>
                                </div>
                                <div class="col-span-2">
                                    <div class="text-gray-500">Net Balance</div>
                                    <div class="text-lg font-semibold <?php echo e($netBalance >= 0 ? 'text-green-600' : 'text-red-600'); ?>"><?php echo e(number_format($netBalance, 2)); ?> PKR</div>
                                </div>
                            </div>
                        </div>
                    </div>
