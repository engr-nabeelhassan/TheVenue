     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                <a href="<?php echo e(route('reports.payment-summary.pdf', request()->query())); ?>" class="bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-purple-700">Download PDF</a>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 border-b border-gray-200">
                    <form method="GET" action="<?php echo e(route('reports.payment-summary')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                    ...
                    <!-- Search Box -->
                    <div class="mt-4">
                        <form method="GET" action="<?php echo e(route('reports.payment-summary')); ?>" class="flex gap-2">
                            ...
                            <a href="<?php echo e(route('reports.payment-summary', ['from_date' => $fromDate, 'to_date' => $toDate])); ?>" 
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-blue-50 p-4 rounded">
                            ...
                            <div class="text-2xl font-bold text-blue-900"><?php echo e(number_format($totalDebit, 2)); ?> PKR</div>
                        </div>
                        <div class="bg-green-50 p-4 rounded">
                            <div class="text-sm text-green-600">Total Credit</div>
                            <div class="text-2xl font-bold text-green-900"><?php echo e(number_format($totalCredit, 2)); ?> PKR</div>
                        </div>
                        <div class="bg-purple-50 p-4 rounded">
                            <div class="text-sm text-purple-600">Net Balance</div>
                            <div class="text-2xl font-bold text-purple-900"><?php echo e(number_format($netBalance, 2)); ?> PKR</div>
                        </div>
                    </div>
                </div>
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <a href="<?php echo e(route('reports.payment-summary', array_merge(request()->query(), ['sort' => 'receipt_date', 'direction' => request('sort')==='receipt_date' && request('direction')==='asc' ? 'desc' : 'asc']))); ?>" 
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <a href="<?php echo e(route('reports.payment-summary', array_merge(request()->query(), ['sort' => 'customer_name', 'direction' => request('sort')==='customer_name' && request('direction')==='asc' ? 'desc' : 'asc']))); ?>" 
                                       class="inline-flex items-center gap-1 hover:text-gray-700">
                                        Customer
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <a href="<?php echo e(route('reports.payment-summary', array_merge(request()->query(), ['sort' => 'payment_method', 'direction' => request('sort')==='payment_method' && request('direction')==='asc' ? 'desc' : 'asc']))); ?>" 
                                       class="inline-flex items-center gap-1 hover:text-gray-700">
                                        Method
                                        <?php if(request('sort')==='payment_method'): ?>
                                            <span class="text-gray-400"><?php echo e(request('direction')==='asc' ? '▲' : '▼'); ?></span>
                                        <?php else: ?>
                                            <span class="text-gray-300">↕</span>
                                        <?php endif; ?>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <a href="<?php echo e(route('reports.payment-summary', array_merge(request()->query(), ['sort' => 'payment_status', 'direction' => request('sort')==='payment_status' && request('direction')==='asc' ? 'desc' : 'asc']))); ?>" 
                                       class="inline-flex items-center gap-1 hover:text-gray-700">
                                        Status
                                        <?php if(request('sort')==='payment_status'): ?>
                                            <span class="text-gray-400"><?php echo e(request('direction')==='asc' ? '▲' : '▼'); ?></span>
                                        <?php else: ?>
                                            <span class="text-gray-300">↕</span>
                                        <?php endif; ?>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($payments->firstItem() + $index); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e(optional($payment->receipt_date)->format('M d, Y')); ?></td>
                ...
                <div class="px-6 py-4 border-t border-gray-200 mt-4 flex items-center justify-between gap-4">
                    <form method="GET" action="<?php echo e(route('reports.payment-summary')); ?>" class="flex items-center gap-2 text-sm">
...
<?php /**PATH C:\Users\Shahjahan\Desktop\the_venue\resources\views/reports/payment-summary.blade.php ENDPATH**/ ?>