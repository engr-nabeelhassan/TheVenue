     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                <a href="<?php echo e(route('bookings.upcoming.pdf', request()->query())); ?>" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 border-b border-gray-200">
                    <form method="GET" action="<?php echo e(route('bookings.upcoming')); ?>" class="space-y-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="<?php echo e(route('bookings.upcoming', ['from_date' => $fromDate, 'to_date' => $toDate])); ?>" 
                        ...
                        <thead class="bg-green-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <a href="<?php echo e(route('bookings.upcoming', array_merge(request()->query(), ['sort' => 'event_start_at', 'direction' => request('sort')==='event_start_at' && request('direction')==='asc' ? 'desc' : 'asc']))); ?>" 
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <a href="<?php echo e(route('bookings.upcoming', array_merge(request()->query(), ['sort' => 'customer_name', 'direction' => request('sort')==='customer_name' && request('direction')==='asc' ? 'desc' : 'asc']))); ?>" 
                                       class="inline-flex items-center gap-1 hover:text-gray-700">
                                        Customer Name
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <a href="<?php echo e(route('bookings.upcoming', array_merge(request()->query(), ['sort' => 'event_type', 'direction' => request('sort')==='event_type' && request('direction')==='asc' ? 'desc' : 'asc']))); ?>" 
                                       class="inline-flex items-center gap-1 hover:text-gray-700">
                                        Event Type
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <div class="flex flex-col">
                                            <div class="font-medium"><?php echo e($booking->event_start_at ? $booking->event_start_at->format('M d, Y') : 'N/A'); ?></div>
                                            <div class="text-xs text-gray-500">
                                                <?php echo e($booking->event_start_at ? $booking->event_start_at->format('h:i A') : 'N/A'); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e($booking->customer->phone ?? $booking->contact ?? 'N/A'); ?>
                ...
                <div class="px-6 py-4 border-t border-gray-200 mt-4 flex items-center justify-between gap-4">
                    <form method="GET" action="<?php echo e(route('bookings.upcoming')); ?>" class="flex items-center gap-2 text-sm">
...
<?php endif; ?>
<?php /**PATH C:\Users\Shahjahan\Desktop\the_venue\resources\views/bookings/upcoming.blade.php ENDPATH**/ ?>