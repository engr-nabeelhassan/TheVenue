...
<body>
    ...
    <div class="header">
        ...
        <p><?php echo e($rangeText); ?></p>
        <?php if($customer): ?>
            <p><strong>Customer:</strong> <?php echo e($customer->full_name); ?> — <?php echo e($customer->phone); ?></p>
        <?php else: ?>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e(optional($payment->receipt_date)->format('M d, Y')); ?></td>
...
<?php /**PATH C:\Users\Shahjahan\Desktop\the_venue\resources\views/payments/details.blade.php ENDPATH**/ ?>