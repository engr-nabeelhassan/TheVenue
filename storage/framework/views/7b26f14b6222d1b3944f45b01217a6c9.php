            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex space-x-2">
                            <a href="<?php echo e(route('bookings.calendar', ['year' => $month == 1 ? $year - 1 : $year, 'month' => $month == 1 ? 12 : $month - 1])); ?>" 
                               class="px-3 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200">
                                ← Previous
                            </a>
                            <a href="<?php echo e(route('bookings.calendar', ['year' => now()->year, 'month' => now()->month])); ?>" 
                               class="px-3 py-2 bg-indigo-100 text-indigo-700 rounded-md hover:bg-indigo-200">
                                Today
                            </a>
                            <a href="<?php echo e(route('bookings.calendar', ['year' => $month == 12 ? $year + 1 : $year, 'month' => $month == 12 ? 1 : $month + 1])); ?>" 
                               class="px-3 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200">
                                Next →
                            </a>
                        </div>
                    ...
                    <div class="grid grid-cols-7 gap-1" id="calendar-grid">
                        ...
                        <?php while($currentDate <= $endDate): ?>
                            ...
                            <div class="relative min-h-[100px] p-2 border border-gray-200 
                                        <?php echo e($isCurrentMonth ? 'bg-white' : 'bg-gray-50'); ?>

                                        <?php echo e($isToday ? 'ring-2 ring-indigo-500' : ''); ?>

                                        <?php echo e($hasBookings ? 'bg-red-50 hover:bg-red-100' : 'hover:bg-green-50'); ?>
                                ...
                                <div class="text-sm font-medium 
                                            ...
                                            <?php echo e($isToday ? 'text-indigo-600' : ''); ?>">
...
<?php /**PATH C:\Users\Shahjahan\Desktop\the_venue\resources\views/bookings/calendar.blade.php ENDPATH**/ ?>