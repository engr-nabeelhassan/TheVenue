        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                <?php if($selectedCustomer): ?>
                    <a href="<?php echo e(route('reports.customer-statements.pdf', request()->query())); ?>" class="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700">Download PDF</a>
                <?php endif; ?>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 border-b border-gray-200">
                    <form method="GET" action="<?php echo e(route('reports.customer-statements')); ?>" class="space-y-4">
                ...
                <?php if($selectedCustomer): ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="space-y-1 text-sm">
                                    <p><span class="font-medium">Name:</span> <?php echo e($selectedCustomer->full_name); ?></p>
                                    <p><span class="font-medium">Phone:</span> <?php echo e($selectedCustomer->phone); ?></p>
                                    <p><span class="font-medium">CNIC:</span> <?php echo e($selectedCustomer->cnic ?? 'N/A'); ?></p>
                                    <p><span class="font-medium">Address:</span> <?php echo e($selectedCustomer->address ?? 'N/A'); ?></p>
                                </div>
                            </div>
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">Statement Period</h3>
                                <div class="space-y-1 text-sm">
                                    <p><span class="font-medium">From:</span> <?php echo e(\Carbon\Carbon::parse($fromDate)->format('M d, Y')); ?></p>
                                    <p><span class="font-medium">To:</span> <?php echo e(\Carbon\Carbon::parse($toDate)->format('M d, Y')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php
                        ...
                        $openingAdvance = \App\Models\Booking::where('customer_id', $customerId)
                            ->where('event_start_at', '<', $fromDate)
                            ->sum('advance_amount');
                        
                        $openingDebits = \App\Models\Payment::where('customer_id', $customerId)
                            ->where('receipt_date', '<', $fromDate)
                            ->where('payment_method', 'Debit')
                            ->sum('add_amount');
                        
                        $openingCredits = \App\Models\Payment::where('customer_id', $customerId)
                            ->where('receipt_date', '<', $fromDate)
                    ...
                    <div class="p-6 border-b border-gray-200">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="bg-blue-50 p-4 rounded">
                                ...
                                <div class="text-2xl font-bold text-blue-900"><?php echo e(number_format($openingBalance, 2)); ?> PKR</div>
                            </div>
                            <div class="bg-green-50 p-4 rounded">
                                <div class="text-sm text-green-600">Total Invoiced</div>
                                <div class="text-2xl font-bold text-green-900"><?php echo e(number_format($totalBookings, 2)); ?> PKR</div>
                            </div>
                            <div class="bg-purple-50 p-4 rounded">
                                <div class="text-sm text-purple-600">Total Paid</div>
                                <div class="text-2xl font-bold text-purple-900"><?php echo e(number_format($totalAdvance + $totalCredits, 2)); ?> PKR</div>
                            </div>
                            <div class="bg-red-50 p-4 rounded">
                                <div class="text-sm text-red-600">Closing Balance</div>
                                <div class="text-2xl font-bold text-red-900"><?php echo e(number_format($closingBalance, 2)); ?> PKR</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="bg-blue-50 font-semibold">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e(\Carbon\Carbon::parse($fromDate)->format('M d, Y')); ?></td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">—</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right"><?php echo e(number_format($openingBalance, 2)); ?></td>
                                </tr>
                                ...
                                <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e(\Carbon\Carbon::parse($transaction['date'])->format('M d, Y')); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($transaction['type'] === 'Booking' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'); ?>">
                                                <?php echo e($transaction['type']); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($transaction['description']); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($transaction['reference']); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">
                                            <?php echo e($transaction['debit'] > 0 ? number_format($transaction['debit'], 2) : '—'); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">
                                            <?php echo e($transaction['credit'] > 0 ? number_format($transaction['credit'], 2) : '—'); ?>
                                ...
                                <tr class="bg-red-50 font-bold">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e(\Carbon\Carbon::parse($toDate)->format('M d, Y')); ?></td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">—</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right"><?php echo e(number_format($totalBookings + $totalDebits, 2)); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right"><?php echo e(number_format($totalAdvance + $totalCredits, 2)); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right"><?php echo e(number_format($closingBalance, 2)); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Shahjahan\Desktop\the_venue\resources\views/reports/customer-statements.blade.php ENDPATH**/ ?>