                    ...
                    <div class="p-6 border-b border-gray-200">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div class="bg-purple-50 p-4 rounded">
                                ...
                                <div class="text-2xl font-bold text-purple-900"><?php echo e(number_format($totalPayments, 2)); ?> PKR</div>
                            </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="bg-red-50 font-bold">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right"><?php echo e(number_format($totalPayments, 2)); ?></td>
