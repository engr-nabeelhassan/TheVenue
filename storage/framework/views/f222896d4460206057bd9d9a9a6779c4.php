     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <a href="<?php echo e(route('bookings.calendar')); ?>" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700">Calendar View</a>
                <a href="<?php echo e(route('bookings.create')); ?>" class="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700">New Booking</a>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <form method="GET" action="<?php echo e(route('bookings.index')); ?>" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="invoice_date_from" value="<?php echo e(request('invoice_date_from')); ?>" 
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">To Date</label>
                                    <input type="date" name="invoice_date_to" value="<?php echo e(request('invoice_date_to')); ?>" 
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
                                </div>
                            </div>
                            <div class="flex gap-2">
