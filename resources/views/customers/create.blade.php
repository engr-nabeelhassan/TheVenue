                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('customers.store') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input id="full_name" name="full_name" type="text" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('full_name') }}" />
                        </div>

                        <div>
                            <label for="cnic" class="block text-sm font-medium text-gray-700">CNIC</label>
                            <input id="cnic" name="cnic" type="text" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('cnic') }}" />
                        </div>

                        <div>
                            <label for="phone" class="block text-sm font-medium text-gray-700">Phone Contact</label>
                            <input id="phone" name="phone" type="text" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('phone') }}" />
                        </div>

                        <div>
                            <label for="address" class="block text-sm font-medium text-gray-700">Address</label>
                            <textarea id="address" name="address" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('address') }}</textarea>
                        </div>
